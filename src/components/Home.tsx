    ...
    <div>
      <div>
        ...
        <div>
          ...
          <p>
            Previously, I've interned as a backend developer and software
            engineer at{" "}
            <a
              className="hover:font-extrabold"
            ...
            rapidly developing applications to production and at larger
            companies, extending more established codebases.
          </p>
          <br />
          <p className="text-2xl mb-2">Now</p>
          <p>
            I'm currently doing my final internship as a software engineer
            intern at{" "}
            <a
              className="hover:font-extrabold"
