        ...
        <div className="ml-2">
          ...
          <div className="mt-2">
            ...
            <p className="text-sm mt-2 ml-5">
              ...
              ingestion tool to collect and ingest 100,000+ data points per day
              of historical cluster metrics using Java, Maven and deployed to
              AWS Lambda, leading to a 7 day reduction in establishment time.
            </p>
          </div>
          <div className="mt-2">
            ...
            <p className="text-sm mt-2 ml-5">
              Resolved a critical logging defect neglected for over 3 months by
              reproducing failures and logs on CentOS.
            </p>
          </div>
          <div className="mt-2">
      ...
      <div className="mt-2">
        ...
        <div className="ml-2">
          <div className="mt-2">
            ...
            <p className="text-sm mt-2 ml-5">
              Developed microservices backend using Java, Spring which includes
              a data scraping service, real-time data processing service using
              Apache Kafka and a service for RESTful APIs, persisting data on
              PostgreSQL and deployed using Docker.
            </p>
          </div>
          <div className="mt-2">
